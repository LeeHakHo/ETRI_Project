dst_vocab = 'cdistnet/utils/charset_EK_cdist.txt'
dst_vocab_size = 2415
rgb2gray =False
...
train = dict(
    ...
    device='cuda',
    gt_file=['/home/ohh/PycharmProject/TSBA-main/data_lmdb_training/merge_MJ_korean/train/'],
    num_worker=16,
    # model_dir ='model/test',
    model_dir='models/CDistNet_merge_voca2415_0227',
    num_epochs=30,
...
val = dict(
    ...
    gt_file= ['/home/ohh/PycharmProject/TSBA-main/data_lmdb_training/merge_MJ_korean/validation'],
...
test = dict(
    ...
    test_list=['/home/ohh/dataset/sample/sample_lmdb'],
    batch_size=128,
    num_worker=8,
    model_dir='models/CDistNet_merge_voca2415_0227',  # load test model
    save_dir='result/CDistNet_merge_voca2415_0227',  #Leehakho
    script_path='utils/Evaluation_TextRecog/script.py',
    python_path='/ohh/anaconda3/envs/ohh/bin/python3.9' #abandon
)
