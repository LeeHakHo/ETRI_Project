...
class LmdbDataset(Dataset):
    ...
    def __init__(self, root: str, charset: str, max_label_len: int, min_image_dim: int = 0,
        ...
        #Leehakho
        if root == "/home/ohh/PycharmProject/parseq-main/data/train/eng_cn/train_cn" or root == "data/train/eng_cn/train_cn" or root == "/home/ohh/PycharmProject/parseq-main/data/test/eng_cn/chinese" or root == "data/test/eng_cn/chinese" or root == "data/test/chinese"\
                or root == "/home/ohh/PycharmProject/parseq-main/data/train/chinese/train" or root == "data/train/chinese/train" or root == "/home/ohh/PycharmProject/parseq-main/data/test/chinese" \
