...
class GCN(TextDataset):
    ...
    def __init__(self, data_root, is_training=True, transform=None, ignore_list=None):
        ...
        self.image_root = os.path.join(data_root, 'obj_train_onlyone' if is_training else 'Test')
        self.annotation_root = os.path.join(data_root, 'obj_train_annotation' if is_training else 'Test')
