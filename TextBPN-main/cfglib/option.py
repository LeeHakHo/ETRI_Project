...
class BaseOptions(object):
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--lr', '--learning-rate', default=0.00001, type=float, help='initial learning rate')
        ...
        # eval args00
        self.parser.add_argument('--checkepoch', default=20, type=int, help='Load checkpoint number')
        ...
        self.parser.add_argument('--dis_threshold', default=0.0, type=float, help='filter the socre < score_i') # 0.3 -> 0

        # demo args
        self.parser.add_argument('--img_root', default='/home/ohh/PycharmProject/TextBPN-main/result', type=str, help='Path to deploy images')
