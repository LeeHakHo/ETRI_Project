...
class BaseOptions(object):
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--save_dir', default='./model/GCN_CRAFT_clip48_noneScd/', help='Path to save checkpoint models')
        self.parser.add_argument('--vis_dir', default='./vis/GCN_CRAFT_clip48_noneScd/', help='Path to save visualization images')
        self.parser.add_argument('--log_dir', default='./logs/GCN_CRAFT_clip48_noneScd/', help='Path to tensorboard log')
        ...
        # train opts
        self.parser.add_argument('--max_epoch', default=20000, type=int, help='Max epochs')
        ...
        self.parser.add_argument('--save_freq', default=500, type=int, help='save weights every # epoch')
        ...
        self.parser.add_argument('--val_freq', default=10000, type=int, help='do validation every # iterations')
