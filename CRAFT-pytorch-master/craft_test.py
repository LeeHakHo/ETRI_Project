...
def saveCropImg(bbox, img, image_path, result_folder):
    i = 0
    for p1, p2, p3, p4 in bbox:
        ...
        try:
            ...
            i = i + 1
            num = str(i).zfill(3)
            print(result_folder + filename + '_' + num + '.jpg', int(p1[0]), int(p2[0]), int(p1[1]), int(p3[1]),
                  type(resized_image))
...
if __name__ == '__main__':
    ...
    for k, image_path in enumerate(image_list):
        ...
        #file_utils.saveResult(image_path, image[:,:,::-1], polys, dirname=result_folder)
        saveCropImg(bboxes, image, image_path, result_folder)
