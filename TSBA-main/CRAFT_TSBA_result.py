...
def TSBA_result(bbox, img, image_name):
    ...
    i = 0
    image_origin = []
    image_origin.append(img)
    image_origin.append(i)
    origin = []
    origin.append(image_origin)
    #label_list = TSBA(args, image_list)
    label_list = TSBA(args, origin)
    for k in range(i):
    ...
    cv2.imwrite('./result/trash/'+image_name + "_result" +'.jpg', img)
...
parser.add_argument('--test_folder', default='/home/ohh/dataset/정리/sample/', type=str, help='folder path to input images')
parser.add_argument('--refine', default=False, action='store_true', help='enable link refiner')
parser.add_argument('--refiner_model', default='weights/craft_refiner_CTW1500.pth', type=str, help='pretrained refiner model')

#args for TSBA
parser.add_argument('--model1', default='/home/ohh/PycharmProject/TSBA-main/saved_models/TRBA_lgmix_0226/iter_60000.pth', help='Path to the first model pth file to ensemble')
...
parser.add_argument('--exp_name', default='result_lgmix_test', help='Where to store logs and results')
...
parser.add_argument('--FeatureExtraction', default='ResNet', type=str, required=False,
...
parser.add_argument('--lgmix', type=bool, default=True, help='Add the Edge Feature as form of a mask.')
