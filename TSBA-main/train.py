...
def init_for_train(opt):
    ...
    return converter, model, criterion, optimizer
...
def train(opt):
    ...
    converter, model, criterion, optimizer = init_for_train(opt)
    if opt.lgmix is True:
        ...
        """ dataset preparation """
        sub_train_dataset = Batch_Balanced_Dataset(sub_opt)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--lgmix', type=bool, default= False) #Leehahko
    ...
    parser.add_argument('--lg', type=bool, default= False ,required=False, help='language classifier')
