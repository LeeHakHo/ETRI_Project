...
if __name__ == '__main__':
    ...
    parser.add_argument('--model1', default='/home/ohh/PycharmProject/TSBA-main/saved_models/merge_EK/iter_60000.pth', help='Path to the first model pth file to ensemble')
    ...
    parser.add_argument('--image_folder', default='/home/ohh/PycharmProject/TSBA-main/result/sample', help='path to image_folder which contains text images')
