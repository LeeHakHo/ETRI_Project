...
def main():
    ...
    config.dataset_charset_path = 'data/charset_EK.txt' #LEEHAKHO
    config.dataset_max_length = 50 #LEEHAKHO
    #config.dataset_image_height = 224  # LEEHAKHO
    #config.dataset_image_width = 224  # LEEHAKHO
